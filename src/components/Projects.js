...
const StyledCard = styled(Card)(({ theme }) => ({
    ...
    '&:hover': {
        ...
        boxShadow: `0px 10px 20px ${theme.palette.grey[400]}`,
    },
}));
...
const projects = [
    {
        title: 'RMRY',
        description: 'Desarrollé la aplicación RMRY para especialistas de equinos en Jalisco usando PHP, JavaScript, Bootstrap, y CSS.',
        link: 'https://demo.registroequino.com/',
        image: 'images/RMRY.png',
    },
    {
        title: 'ExentoPlus',
        description: 'Sistema de Gestión de la Docencia ExentoPlus desarrollado utilizando principalmente Laravel 10, con pruebas automatizadas, JavaScript, y JQuery.',
        link: 'https://epra.exentoplus.com/',
        image: 'images/EXENTOPLUS.png',
    },
    {
        title: 'PROESDE',
        description: 'Desarrollé el sistema para el Programa de Estímulos al Desempeño Docente (PROESDE) usando Laravel 10, con pruebas automatizadas.',
